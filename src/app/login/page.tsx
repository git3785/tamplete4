  ...
  return (
    ...
    <header className="py-8 bg-violet-50 text-center w-full h-60 md:text-left">
      <div className="container mx-auto px-4">
        <h1 className="text-2xl mt-10 md:text-3xl font-bold text-blue-950">My Account</h1>
...
<div className="w-full h-auto flex justify-center items-center pt-20">
  <div className="bg-white shadow-lg rounded-lg px-8 py-10 max-w-md w-full">
    <h2 className="text-2xl font-bold text-center text-blue-950">Login</h2>
    ...
    <form className="mt-6 space-y-4">
      ...
      <button
        type="submit"
        className="w-full bg-pink-600 mb-11 text-white py-2 rounded-md hover:bg-pink-500 transition"
      >
        Sign In
      </button>
    </form>
    ...
    <p className="mt-12 text-center text-sm text-gray-600">
      ...
      <a href="/createaccount" className="text-purple-600 hover:underline">
        Create account
      </a>
    </p>
  </div>
