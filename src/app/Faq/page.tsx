...
<header className="py-8 bg-gray-100 text-center w-full h-60 md:text-left">
      <div className="container mx-auto px-4">
        <h1 className="text-2xl mt-10 md:text-3xl font-bold  text-blue-950">FAQ</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* General Information */}
          <section>
            <h2 className="text-2xl font-bold mb-6  text-blue-950">General Information</h2>
          ...
          <section className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-6  text-blue-950">Ask a Question</h2>
